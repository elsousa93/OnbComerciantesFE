...
export class TokenService {
  ...
  async getLoginToken(username?: string, bank?: string, bankLocation?: string, profile?: string, tenant?: string): Promise<any> {
    ...
    return this.http.post(URI, 'grant_type=client_credentials&subject=' + username + '&display_name=' + username + '&claim-bank=' + bank + '&claim-bankLocation=' + bankLocation + '&claim-acquiring-profile=' + profile + '&claim-tenant=' + tenant + '&claim-subject=' + username + '&claim-display_name=' + username, HTTP_OPTIONS_AUTH).toPromise();
  }
